...
function basic_getting_and_setting() {
  ...
  e.parse(
    '{ "parameters" : { "param1" : { "name" : "foo", "value" : 0.1 }, "param2" : { "name" : "bar", "value" : 3.1415 } } }'
  );
  ...
  if (there_is_coffee) post('    There is coffee!');
  if (there_is_tea) post('    there is tea!');
  ...
  post(
    '    Sizes is of type ' +
      d.gettype('drink::hot::coffee::sizes') +
      '   and origin is of type ' +
      d.gettype('drink::hot::coffee::origin')
  );
  post();
